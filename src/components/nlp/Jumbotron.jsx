...
const cards = [
    ...
    {
        title: "Company Name Extractor",
        subtitle: "Instantly find the sender’s company.",
        image: "/images/iphone-camera.jpg",
        bg: "bg-blue-900",
        text: "text-white",
    },
    {
        title: "Interview Status Detector",
        subtitle: "Pass or fail, know in seconds.",
        image: "/images/iphone-chip.jpg",
        bg: "bg-neutral-900",
        text: "text-white",
    },
    {
        title: "Editable Interview Status",
        subtitle: "Update results after a second look.",
        image: "/images/iphone-blue.jpg",
        bg: "bg-gray-100",
        text: "text-black",
    },
    {
        title: "Save & Reopen Lists",
